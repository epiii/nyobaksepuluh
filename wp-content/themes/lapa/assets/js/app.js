...
(function($) {
    ...
    LA.core.MegaMenu = function(){
        ...
        function fix_megamenu_position( $elem, containerClass, container_width, isVerticalMenu) {
            ...
            if (!isVerticalMenu) {
                ...
                if(containerClass == 'body.lapa-body'){
                    ...
                    $('li.mm-popup-wide', _that).each(function(){
                        ...
                        if( $menu_item.hasClass('mm-popup-force-fullwidth')){
                            ...
                            if(!isVerticalMenu){
                                ...
                                _containerClass = 'body.lapa-body';
                            }else{
    ...
    LA.core.HeaderSticky = function(){
        ...
        var prepareHeightForHeader = function (){
            ...
            if(winW > 992){
                if($.exists($masthead)){
                    if($body.hasClass('header-v7') || $body.hasClass('header-v8') || $body.hasClass('header-v9')){
                        var _hv7_height = $('.site-header .site-header__nav-primary').innerHeight();
    ...
    LA.core.WooCommerce = function(){
        ...
        $document.on('click','.product a.add_wishlist:not(.la-core-wishlist)',function(e){
            if(!$(this).hasClass('added')) {
                e.preventDefault();
                var $button     = $(this),
        ...
        $document.on('adding_to_cart', function( e, $button, data ){
            if( $button.closest('.la_wishlist_table').length ) {
        ...
        $document
            .on('click','.wc-view-toggle span',function(){
                ...
                if(!_this.hasClass('active')){
                    ...
                    Cookies.set('lapa_wc_catalog_view_mode', _mode, { expires: 2 });
                }
            });
    ...
    LA.core.AjaxShopFilter = function(){
        ...
        var target_to_init = '#la_shop_products .la-pagination a, .la-advanced-product-filters-result a',
            target_to_init2 = '.wc-ordering a, .wc-view-count a, .woocommerce.product-sort-by a, .woocommerce.la-price-filter-list a, .woocommerce.widget_layered_nav a, .woocommerce.widget_product_tag_cloud li a, .woocommerce.widget_product_categories a',
        ...
        LA.utils.eventManager.subscribe('LA:AjaxShopFilter', function(e, url, element){
            ...
            if( $('.wc-toolbar-container').length > 0) {
                if($('.wc-toolbar-container > .wc-toolbar-top').hasClass('hidden')){
                    $('.wc-toolbar-container').removeClass('margin-bottom-0');
                }
                else{
                    $('.wc-toolbar-container').addClass('margin-bottom-0');
                }
    ...
    LA.component.NewsletterPopup = function(el){
        var $popup = $(el),
            show_on_mobile = $popup.attr('data-show-mobile'),
            p_delay = parseInt($popup.attr('data-delay')),
            backtime = parseInt($popup.attr('data-back-time'));
        ...
        return {
            init : function(){
                ...
                try{
                    if(Cookies.get('lapa_dont_display_popup') == 'yes'){
                        return;
                    }
                }catch (ex){}
                ...
                $(window).load(function(){
                    setTimeout(function(){
                        lightcase.start({
                            ...
                            onInit : {
                                foo: function() {
                                    $('body.lastudio-lapa').addClass('open-newsletter-popup');
                                }
                            },
                            onClose : {
                                qux: function() {
                                    if($('.cbo-dont-show-popup', $popup).length && $('.cbo-dont-show-popup', $popup).is(':checked')){
                                        try {
                                            Cookies.set('lapa_dont_display_popup', 'yes', { expires: backtime, path: '/' });
                                        } catch (ex){}
                                    }
                                    $('body.lastudio-lapa').removeClass('open-newsletter-popup');
                                }
                            },
                            onFinish: {
