        ...
        <div class="row portfolio-nav">
            <div class="col-xs-4">
                ...
                if(!empty($prev) && isset($prev->ID)){
                    printf(
                        '<a href="%s"><svg class="dlicon-arrow-left5" width="26px" height="26px"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#dlicon-arrow-left5"></use></svg><span>%s</span></a>',
                        get_the_permalink($prev->ID),
                        esc_html_x('Prev', 'front-end', 'lapa')
                    );
                }
                ?>
            </div>
            <div class="col-xs-4">
                ...
                if ( is_array( $post_terms ) && isset( $post_terms[0] ) && is_object( $post_terms[0] ) ) {
                    ...
                    echo sprintf('<a href="%s"><i class="fa fa-th-large"></i></a>',
            ...
            <div class="col-xs-4">
                ...
                if(!empty($next) && isset($next->ID)){
                    printf(
                        '<a href="%s"><span>%s</span><svg class="dlicon-arrow-right5" width="26px" height="26px"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#dlicon-arrow-right5"></use></svg></a>',
                        get_the_permalink($next->ID),
                        esc_html_x('Next', 'front-end', 'lapa')
                    );
                }
                ?>
            </div>
